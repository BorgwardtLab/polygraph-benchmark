...
#SBATCH --job-name=perturbation-experiments-cropped
#SBATCH --output=./perturbation/results_cropped/job_%A_%a.out
#SBATCH --error=./perturbation/results_cropped/job_%A_%a.err
